...
footer.innerHTML = `
<footer class="relative overflow-hidden bg-[#51005f] text-white">
  <div aria-hidden class="pointer-events-none absolute inset-0">
    ...
    <div class="absolute inset-0 bg-[#51005f]/60"></div>
    ...
    <div class="grid gap-10 lg:grid-cols-12">
      <div class="lg:col-span-5" data-aos="fade-up" data-aos-duration="900">
        <a href="./index.html" class="inline-flex items-center gap-3">
          ...
          <span class="text-lg font-semibold tracking-tight">Appliance Repairman</span>
        </a>
      ...
      <div class="lg:col-span-7 grid gap-8 sm:grid-cols-2" data-aos="fade-up" data-aos-delay="120" data-aos-duration="900">
        <div class="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          ...
          <ul class="mt-4 grid gap-3 text-sm">
            ...
            <li><a class="text-white/75 hover:text-white" href="./faq.html">Help</a></li>
            <li><a class="text-white/75 hover:text-white" href="./contact.html">Contact</a></li>
            <li><a class="text-white/75 hover:text-white" href="./local-appliance-repair.html">Local appliance repairman</a></li>
          </ul>
        </div>
        ...
        <div class="sm:col-span-2 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <form class="flex w-full max-w-md items-center gap-3">
              <input
                ...
                class="h-12 w-full rounded-xl border border-white/15 bg-white/10 px-4 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#f3008c]/40 focus:ring-2 focus:ring-[#f3008c]/25"
              />
              <button type="submit" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#51005f] px-5 text-sm font-semibold text-white hover:brightness-95">
          ...
          <div class="mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-5">
            <div class="text-xs text-white/60">&copy; <span id="y"></span> Appliance Repairman. All rights reserved.</div>
