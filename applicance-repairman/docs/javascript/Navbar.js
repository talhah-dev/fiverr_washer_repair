      ...
      <div id="navBar" class="relative mt-3 flex items-center justify-between rounded-2xl px-3 py-2.5 transition-all duration-300">
        ...
        <nav class="hidden md:block">
          <ul class="flex items-center justify-center gap-3 lg:gap-6 text-sm font-semibold">
                  ...
                  <div class="mt-2 border-t border-zinc-200 pt-2">
                    <a href="local-appliance-repair.html" class="menuItem group flex items-center justify-between gap-3 rounded-2xl p-3 transition">
                      <span class="inline-flex items-center gap-3">
                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#51005f]/10 ring-1 ring-[#51005f]/15">
                          <i class="fa-solid text-xs fa-location-dot text-[#51005f]"></i>
                        </span>
                        <span class="text-sm font-semibold">Local appliance repairman</span>
                      </span>
                    </a>
                  </div>
                </div>
            ...
            <li><a class="navLink transition" href="faq.html">Help</a></li>
  ...
  >
    <div class="flex items-center justify-between px-5 py-5">
      <a href="index.html" class="inline-flex items-center gap-3">
        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/10 ring-1 ring-[#51005f]/15 text-[#51005f]">
          <i class="fa-solid fa-wrench"></i>
        </span>
      ...
      <button
        ...
        class="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/4 text-[#51005f] transition hover:bg-[#51005f]/15 active:scale-[0.98]"
      >
    ...
    <div class="px-5">
      ...
      <nav class="mt-5">
        <ul class="space-y-2">
          <li>
            <a class="mLink flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#161616] ring-1 ring-[#51005f]/15 hover:bg-[#51005f]/5 transition"
              href="index.html">
          ...
          <li class="rounded-2xl ring-1 ring-[#51005f]/15 overflow-hidden">
            <button
              id="mServicesTrigger"
              type="button"
              aria-expanded="false"
              class="flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-sm font-semibold text-[#161616] hover:bg-[#51005f]/5 transition"
            >
              <span class="inline-flex items-center gap-3">
               
                Services
              </span>
              <span class="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-2xl bg-white text-[#161616] ring-1 ring-[#51005f]/15">
            ...
            <div id="mServicesPanel" class="max-h-0 overflow-hidden transition-[max-height] duration-300 ease-out bg-white">
              <div class="p-3 space-y-2">
                <a class="mSub flex items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#161616] bg-[#51005f]/5 hover:bg-[#51005f]/10 transition"
       ...
       <div class="rounded-2xl border border-[#51005f]/15 bg-[#51005f]/5 p-4 mt-5">
        <div class="flex items-start gap-3">
          <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/10 text-[#51005f] ring-1 ring-[#51005f]/15">
            <i class="fa-solid fa-wrench"></i>
          </span>
          <div class="flex-1">
            <p class="text-sm font-extrabold text-[#51005f]">Fast diagnosis, clean repair</p>
            <p class="mt-1 text-sm text-[#51005f]/70">Choose an appliance service or book a repair visit.</p>
          </div>
        </div>
        ...
        <div class="mt-4 grid gap-2">
          ...
          <a href="index.html#services"
            class="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-[#51005f]/15 bg-white p-3 text-sm font-extrabold text-[#51005f] shadow-sm transition hover:bg-[#51005f]/5 focus:outline-none focus:ring-2 focus:ring-[#51005f]/20">
            View Services
          </a>
        </div>
      </div>
...
const setDropdownStyle = (mode) => {
  ...
  if (mode === "top") {
    servicesMenuBox.className = "rounded-2xl border border-white/10 bg-[#51005f]/95 p-3 shadow-2xl shadow-black/30 backdrop-blur";
    ...
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/15 text-[#f3008c]"));
    ...
    items.forEach((x) => (x.className = "menuItem group flex items-start gap-3 rounded-2xl p-3 transition text-[#161616] hover:bg-[#51005f]/5"));
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/10 ring-1 ring-[#51005f]/15 text-[#51005f]"));
    arrows.forEach((x) => (x.className = "menuArrow flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/10 ring-1 ring-[#51005f]/15 text-[#161616]"));
  }
};
...
const setTopStyle = () => {
  ...
  if (brandText) brandText.className = "block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight text-[#51005f]";
  if (brandSub) brandSub.className = "block text-xs text-[#51005f]/60";
  if (brandMark) brandMark.className = "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ring-1 ring-[#51005f]/15 bg-[#51005f]/10 text-[#51005f]";
  ...
  if (ctaBtn) ctaBtn.className = "inline-flex items-center gap-2 rounded-2xl bg-[#51005f] pr-4 pl-1.5 py-1.5 text-sm font-semibold text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 active:translate-y-0";
  ...
  if (menuBtn) menuBtn.className = "group inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#51005f]/5 text-[#51005f] ring-1 ring-[#51005f]/15 transition hover:bg-[#51005f]/15 active:scale-[0.98] md:hidden";
