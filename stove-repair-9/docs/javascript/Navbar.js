      ...
      <div id="navBar" class="relative mt-3 flex items-center justify-between rounded-2xl px-3 py-2.5 transition-all duration-300">
        <a href="index.html" class="inline-flex items-center gap-3 shrink-0">
          ...
          <span class="leading-tight font-semibold">
            <span id="brandText" class="block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight">Stove Repair</span>
              ...
              >
                <div id="servicesMenuBox" class="rounded-2xl border p-3 shadow-2xl">
                  ...
                  <div class="mt-2 border-t border-zinc-200 pt-2">
                    <a href="local-stove-repair.html" class="menuItem group flex items-center justify-between gap-3 rounded-2xl p-3 transition">
                      <span class="inline-flex items-center gap-3">
                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#002d64]/10 ring-1 ring-[#002d64]/15">
                          <i class="fa-solid text-xs fa-location-dot text-[#002d64]"></i>
                        </span>
                        <span class="text-sm font-semibold">Local stove repair</span>
                      </span>
                    </a>
                  </div>
                </div>
  ...
  >
    <div class="flex items-center justify-between px-5 py-5">
      <a href="index.html" class="inline-flex items-center gap-3">
        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/10 ring-1 ring-[#002d64]/15 text-[#002d64]">
          <i class="fa-solid fa-wrench"></i>
        </span>
        <span class="leading-tight font-semibold text-[#002d64]">
            <span id="brandText" class="block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight">Stove Repair</span>
            <span id="brandSub" class="block  text-xs   opacity-75">Fast Clean Reliable</span>
          </span>
      </a>
      ...
      <button
        ...
        class="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/4 text-[#002d64] transition hover:bg-[#002d64]/15 active:scale-[0.98]"
      >
    ...
    <div class="px-5">
      ...
      <nav class="mt-5">
        <ul class="space-y-2">
          <li>
            <a class="mLink flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#161616] ring-1 ring-[#002d64]/15 hover:bg-[#002d64]/5 transition"
              href="index.html">
          ...
          <li class="rounded-2xl ring-1 ring-[#002d64]/15 overflow-hidden">
            <button
              id="mServicesTrigger"
              type="button"
              aria-expanded="false"
              class="flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-sm font-semibold text-[#161616] hover:bg-[#002d64]/5 transition"
            >
              <span class="inline-flex items-center gap-3">
               
                Services
              </span>
              <span class="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-2xl bg-white text-[#161616] ring-1 ring-[#002d64]/15">
       ...
       <div class="rounded-2xl border border-[#002d64]/15 bg-[#002d64]/5 p-4 mt-5">
        <div class="flex items-start gap-3">
          <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/10 text-[#002d64] ring-1 ring-[#002d64]/15">
            <i class="fa-solid fa-wrench"></i>
          </span>
          <div class="flex-1">
            <p class="text-sm font-extrabold text-[#002d64]">Fast diagnosis, clean repair</p>
            <p class="mt-1 text-sm text-[#002d64]/70">Choose a service or book a repair visit.</p>
          </div>
        </div>

        <div class="mt-4 grid gap-2">
          <a href="contact.html"
            class="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#002d64] p-3 text-sm font-extrabold text-white shadow-lg shadow-black/10 transition hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-[#002d64]/30">
            Book Service
          </a>

          <a href="index.html#services"
            class="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-[#002d64]/15 bg-white p-3 text-sm font-extrabold text-[#002d64] shadow-sm transition hover:bg-[#002d64]/5 focus:outline-none focus:ring-2 focus:ring-[#002d64]/20">
            View Services
          </a>
        </div>
      </div>
...
const setDropdownStyle = (mode) => {
  ...
  if (mode === "top") {
    servicesMenuBox.className = "rounded-2xl border border-white/10 bg-[#002d64]/95 p-3 shadow-2xl shadow-black/30 backdrop-blur";
    ...
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/15 text-[#c46401]"));
    ...
    items.forEach((x) => (x.className = "menuItem group flex items-start gap-3 rounded-2xl p-3 transition text-[#161616] hover:bg-[#002d64]/5"));
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/10 ring-1 ring-[#002d64]/15 text-[#002d64]"));
    arrows.forEach((x) => (x.className = "menuArrow flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/10 ring-1 ring-[#002d64]/15 text-[#161616]"));
  }
};
...
const setTopStyle = () => {
  ...
  if (brandText) brandText.className = "block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight text-[#002d64]";
  if (brandSub) brandSub.className = "block text-xs text-[#002d64]/60";
  if (brandMark) brandMark.className = "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ring-1 ring-[#002d64]/15 bg-[#002d64]/10 text-[#002d64]";
  ...
  if (ctaBtn) ctaBtn.className = "inline-flex items-center gap-2 rounded-2xl bg-[#002d64] pr-4 pl-1.5 py-1.5 text-sm font-semibold text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 active:translate-y-0";
  ...
  if (menuBtn) menuBtn.className = "group inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#002d64]/5 text-[#002d64] ring-1 ring-[#002d64]/15 transition hover:bg-[#002d64]/15 active:scale-[0.98] md:hidden";
