...
footer.innerHTML = `
<footer class="relative overflow-hidden bg-[#1E3A8A] text-white">
  <div aria-hidden class="pointer-events-none absolute inset-0">
    ...
    <div class="absolute inset-0 bg-[#1E3A8A]/60"></div>
    ...
    <div class="grid gap-10 lg:grid-cols-12">
      <div class="lg:col-span-5" data-aos="fade-up" data-aos-duration="900">
        <a href="./index.html" class="inline-flex items-center gap-3">
          ...
          <span class="text-lg font-semibold tracking-tight">AC Repair</span>
        </a>

        <p class="mt-4 max-w-md text-sm leading-relaxed text-white/75">
          Professional AC repair with careful diagnosis, clear estimates, and reliable in-home service.
        </p>

        <div class="mt-6 flex flex-wrap gap-3">
          <a href="./contact.html" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#1E3A8A] px-6 text-sm font-semibold md:w-auto w-full text-center text-white shadow-lg shadow-black/20 hover:brightness-95">
      ...
      <div class="lg:col-span-7 grid gap-8 sm:grid-cols-2" data-aos="fade-up" data-aos-delay="120" data-aos-duration="900">
        <div class="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          ...
          <ul class="mt-4 grid gap-3 text-sm">
            ...
            <li><a class="text-white/75 hover:text-white" href="./local-ac-repair.html">Local ac repair</a></li>
          </ul>
        </div>
        ...
        <div class="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          ...
          <ul class="mt-4 grid gap-3 text-sm">
            <li><a class="text-white/75 hover:text-white" href="./ac-not-cooling.html">AC not cooling</a></li>
            <li><a class="text-white/75 hover:text-white" href="./ac-leaking-water.html">AC leaking water</a></li>
            <li><a class="text-white/75 hover:text-white" href="./ac-wont-turn-on.html">AC won't turn on</a></li>
            <li><a class="text-white/75 hover:text-white" href="./ac-making-noise.html">AC making noise</a></li>
          </ul>
        </div>
        ...
        <div class="sm:col-span-2 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div class="text-sm font-semibold">AC care tips</div>
              <div class="mt-1 text-sm text-white/75">Simple maintenance updates to help keep your AC running efficiently and delivering reliable cooling.</div>
            </div>
            <form class="flex w-full max-w-md items-center gap-3">
              <input
                ...
                class="h-12 w-full rounded-xl border border-white/15 bg-white/10 px-4 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#E0F2FE]/40 focus:ring-2 focus:ring-[#E0F2FE]/25"
              />
              <button type="submit" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#1E3A8A] px-5 text-sm font-semibold text-white hover:brightness-95">
          ...
          <div class="mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-5">
            <div class="text-xs text-white/60">&copy; <span id="y"></span> AC Repair. All rights reserved.</div>
