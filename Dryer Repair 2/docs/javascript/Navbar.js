      ...
      <div id="navBar" class="relative mt-3 flex items-center justify-between rounded-2xl px-3 py-2.5 transition-all duration-300">
        <a href="index.html" class="inline-flex items-center gap-3 shrink-0">
          ...
          <span class="leading-tight font-semibold">
            <span id="brandText" class="block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight">Dryer Repair</span>
            ...
            <li class="relative">
              ...
              >
                <div id="servicesMenuBox" class="rounded-2xl border p-3 shadow-2xl">
                  <a href="dryer-not-heating.html" class="menuItem group flex items-start gap-3 rounded-2xl p-3 transition">
                    
                    <div class="flex-1">
                      <p class="text-sm font-semibold">Dryer not heating</p>
                      <p class="mt-1 text-xs opacity-75">Heat, fuse & thermostat checks</p>
                    </div>
                  ...
                  <a href="dryer-taking-too-long.html" class="menuItem group flex items-start gap-3 rounded-2xl p-3 transition">
                   
                    <div class="flex-1">
                      <p class="text-sm font-semibold">Dryer taking too long</p>
                  ...
                  <a href="dryer-wont-start.html" class="menuItem group flex items-start gap-3 rounded-2xl p-3 transition">
                  
                    <div class="flex-1">
                      <p class="text-sm font-semibold">Dryer won't start</p>
                      <p class="mt-1 text-xs opacity-75">Power, switch & control checks</p>
                    </div>
                    <span class="menuArrow flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl ring-1">
                      <i class="fa-solid fa-arrow-right text-xs"></i>
                    </span>
                  ...
                  <a href="noisy-dryer.html" class="menuItem group flex items-start gap-3 rounded-2xl p-3 transition">
                  
                    <div class="flex-1">
                      <p class="text-sm font-semibold">Noisy dryer</p>
                  ...
                  <div class="mt-2 border-t border-zinc-200 pt-2">
                    <a href="local-dryer-repair.html" class="menuItem group flex items-center justify-between gap-3 rounded-2xl p-3 transition">
                      <span class="inline-flex items-center gap-3">
                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#282828]/10 ring-1 ring-[#282828]/15">
                          <i class="fa-solid text-xs fa-location-dot text-[#282828]"></i>
                        </span>
                        <span class="text-sm font-semibold">Local dryer repair</span>
                      </span>
                    </a>
                  </div>
                </div>
  ...
  >
    <div class="flex items-center justify-between px-5 py-5">
      <a href="index.html" class="inline-flex items-center gap-3">
        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/10 ring-1 ring-[#282828]/15 text-[#282828]">
          <i class="fa-solid fa-wrench"></i>
        </span>
        <span class="leading-tight font-semibold text-[#282828]">
            <span id="brandText" class="block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight">Dryer Repair</span>
            <span id="brandSub" class="block  text-xs   opacity-75">Fast Clean Reliable</span>
          </span>
      </a>
      ...
      <button
        ...
        class="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/4 text-[#282828] transition hover:bg-[#282828]/15 active:scale-[0.98]"
      >
    ...
    <div class="px-5">
      ...
      <nav class="mt-5">
        <ul class="space-y-2">
          <li>
            <a class="mLink flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#282828] ring-1 ring-[#282828]/15 hover:bg-[#282828]/5 transition"
              href="index.html">
          ...
          <li class="rounded-2xl ring-1 ring-[#282828]/15 overflow-hidden">
            <button
              id="mServicesTrigger"
              type="button"
              aria-expanded="false"
              class="flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-sm font-semibold text-[#282828] hover:bg-[#282828]/5 transition"
            >
              <span class="inline-flex items-center gap-3">
               
                Services
              </span>
              <span class="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-2xl bg-white text-[#282828] ring-1 ring-[#282828]/15">
            ...
            <div id="mServicesPanel" class="max-h-0 overflow-hidden transition-[max-height] duration-300 ease-out bg-white">
              <div class="p-3 space-y-2">
                <a class="mSub flex items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#282828] bg-[#282828]/5 hover:bg-[#282828]/10 transition"
                  href="dryer-not-heating.html">
                  <span class="inline-flex items-center gap-3">
                ...
                <a class="mSub flex items-center justify-between gap-3 rounded-2xl px-4 py-3 text-sm font-semibold text-[#282828] bg-[#282828]/5 hover:bg-[#282828]/10 transition"
                  href="dryer-taking-too-long.html">
                  <span class="inline-flex items-center gap-3">
       ...
       <div class="rounded-2xl border border-[#282828]/15 bg-[#282828]/5 p-4 mt-5">
        <div class="flex items-start gap-3">
          <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/10 text-[#282828] ring-1 ring-[#282828]/15">
            <i class="fa-solid fa-wrench"></i>
          </span>
          <div class="flex-1">
            <p class="text-sm font-extrabold text-[#282828]">Fast diagnosis, clean repair</p>
            <p class="mt-1 text-sm text-[#282828]/70">Choose a dryer service or book a visit.</p>
          </div>
        </div>

        <div class="mt-4 grid gap-2">
          <a href="contact.html"
            class="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#282828] p-3 text-sm font-extrabold text-white shadow-lg shadow-black/10 transition hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-[#282828]/30">
            Book Service
          </a>

          <a href="index.html#services"
            class="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-[#282828]/15 bg-white p-3 text-sm font-extrabold text-[#282828] shadow-sm transition hover:bg-[#282828]/5 focus:outline-none focus:ring-2 focus:ring-[#282828]/20">
            View Services
          </a>
        </div>
      </div>
...
const setDropdownStyle = (mode) => {
  ...
  if (mode === "top") {
    servicesMenuBox.className = "rounded-2xl border border-white/10 bg-[#282828]/95 p-3 shadow-2xl shadow-black/30 backdrop-blur";
    ...
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/15 text-[#FE6D01]"));
    ...
    dropDot.className = "flex h-6 w-6 shrink-0 items-center justify-center rounded-full ring-1 ring-[#282828]/10 bg-[#282828]/5 text-[#282828]/80";
    dropIcon.className = "fa-solid fa-chevron-down text-xs text-[#282828]/80";

    items.forEach((x) => (x.className = "menuItem group flex items-start gap-3 rounded-2xl p-3 transition text-[#282828] hover:bg-[#282828]/5"));
    icons.forEach((x) => (x.className = "menuIcon flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/10 ring-1 ring-[#282828]/15 text-[#282828]"));
    arrows.forEach((x) => (x.className = "menuArrow flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/10 ring-1 ring-[#282828]/15 text-[#282828]"));
  }
};
...
const setTopStyle = () => {
  ...
  if (brandText) brandText.className = "block -mb-0.5 text-base sm:text-lg font-extrabold tracking-tight text-[#fe6d01]";
  if (brandSub) brandSub.className = "block text-xs text-[#fe6d01]/60";
  if (brandMark) brandMark.className = "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ring-1 ring-[#282828]/15 bg-[#fe6d01]/10 text-[#fe6d01]";
  navLinks.forEach((a) => (a.className = "navLink inline-flex items-center gap-1 text-[#282828]/80 hover:text-[#282828] transition"));
  if (servicesTrigger) servicesTrigger.className = "dropTrigger inline-flex items-center gap-2 text-[#282828]/80 hover:text-[#282828] transition";
  if (ctaBtn) ctaBtn.className = "inline-flex items-center gap-2 rounded-2xl bg-[#FE6D01] pr-4 pl-1.5 py-1.5 text-sm font-semibold text-white shadow-lg shadow-black/10 transition hover:-translate-y-0.5 active:translate-y-0";
  ...
  if (menuBtn) menuBtn.className = "group inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#282828]/5 text-[#282828] ring-1 ring-[#282828]/15 transition hover:bg-[#282828]/15 active:scale-[0.98] md:hidden";
