...
footer.innerHTML = `
<footer class="relative overflow-hidden bg-[#282828] text-white">
  <div aria-hidden class="pointer-events-none absolute inset-0">
    ...
    <div class="absolute inset-0 bg-[#282828]/60"></div>
      ...
      <div class="lg:col-span-5" data-aos="fade-up" data-aos-duration="900">
        <a href="./index.html" class="inline-flex items-center gap-3">
          <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/15">
            <i class="fa-solid fa-wrench text-[#FE6D01]"></i>
          </span>
          <span class="text-lg font-semibold tracking-tight">Dryer Repair</span>
        </a>

        <p class="mt-4 max-w-md text-sm leading-relaxed text-white/75">
          Professional dryer repair with clear estimates, clean workmanship, and reliable in-home service.
        </p>

        <div class="mt-6 flex flex-wrap gap-3">
          <a href="./contact.html" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#FE6D01] px-6 text-sm font-semibold md:w-auto w-full text-center text-[#282828] shadow-lg shadow-black/20 hover:brightness-95">
        ...
        <div class="mt-8 md:flex hidden flex-wrap gap-3">
          <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm text-white/85 backdrop-blur">
            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/20">
              <i class="fa-solid text-xs fa-shield-halved text-[#FE6D01]"></i>
            </span>
            Warranty-backed
          </span>
          <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm text-white/85 backdrop-blur">
            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/20">
              <i class="fa-solid text-xs fa-stopwatch text-[#FE6D01]"></i>
            </span>
            Same-day options
          </span>
        </div>
      ...
      <div class="lg:col-span-7 grid gap-8 sm:grid-cols-2" data-aos="fade-up" data-aos-delay="120" data-aos-duration="900">
        <div class="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          <div class="flex items-center justify-between gap-4">
            ...
            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/20">
              <i class="fa-solid text-xs fa-chevron-right text-[#FE6D01]"></i>
            </span>
          </div>
          ...
          <ul class="mt-4 grid gap-3 text-sm">
            ...
            <li><a class="text-white/75 hover:text-white" href="./local-dryer-repair.html">Local dryer repair</a></li>
          </ul>
        </div>
        ...
        <div class="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          <div class="flex items-center justify-between gap-4">
            ...
            <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15 ring-1 ring-white/20">
              <i class="fa-solid text-xs fa-wrench text-[#FE6D01]"></i>
            </span>
          </div>

          <ul class="mt-4 grid gap-3 text-sm">
            <li><a class="text-white/75 hover:text-white" href="./dryer-not-heating.html">Dryer not heating</a></li>
            <li><a class="text-white/75 hover:text-white" href="./dryer-taking-too-long.html">Dryer taking too long</a></li>
            <li><a class="text-white/75 hover:text-white" href="./dryer-wont-start.html">Dryer won't start</a></li>
            <li><a class="text-white/75 hover:text-white" href="./noisy-dryer.html">Noisy dryer</a></li>
          </ul>
        </div>
        ...
        <div class="sm:col-span-2 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
          <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div class="text-sm font-semibold">Dryer care tips</div>
              <div class="mt-1 text-sm text-white/75">Simple updates and maintenance tips to help keep your dryer running safely and smoothly.</div>
            </div>
            <form class="flex w-full max-w-md items-center gap-3">
              <input
                ...
                class="h-12 w-full rounded-xl border border-white/15 bg-white/10 px-4 text-sm text-white outline-none placeholder:text-white/50 focus:border-[#FE6D01]/40 focus:ring-2 focus:ring-[#FE6D01]/25"
              />
              <button type="submit" class="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#FE6D01] px-5 text-sm font-semibold text-[#282828] hover:brightness-95">
          ...
          <div class="mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-5">
            <div class="text-xs text-white/60">Â© <span id="y"></span> Dryer Repair. All rights reserved.</div>
